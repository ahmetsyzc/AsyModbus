...
public class OrtakAlanlar
{
    ...
    {
        get { return eklenmeTarih; }
        set { eklenmeTarih = value; }
    }

    private int guncelleyenId;
    public int GuncelleyenId
    {
        get { return guncelleyenId; }
        set { guncelleyenId = value; }
    }

    private string guncelleyenIp;
    public string GuncelleyenIp
    {
        get { return guncelleyenIp; }
        set { guncelleyenIp = value; }
    }

    private DateTime guncellenmeTarih;
    public DateTime GuncellenmeTarih
    {
        get { return guncellenmeTarih; }
        set { guncellenmeTarih = value; }
    }
    ...
    private DataRow veriSatiri;
    public DataRow VeriSatiri
    {
        get { return veriSatiri; }
        set { veriSatiri = value; }
    }

    private DataTable veriTablosu;
